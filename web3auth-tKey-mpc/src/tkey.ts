...
const torusSp = new TorusServiceProvider({
  ...
  customAuthArgs: {
    ...
    web3AuthClientId: process.env.REACT_APP_WEB3AUTHCLIENTID!, // anything will work on localhost, but get one valid clientID before hosting, from https://dashboard.web3auth.io
